...
if chart_series.empty:
    ...
    # ----- Time period selector (for re-basing the chart) -----
    ...
    selected_period = st.selectbox("Time period", period_options, index=7)  # default 5Y
    ...
    normalized_series = (filtered_series / filtered_series.iloc[0] - 1) * 100
    ...
    # Set x-axis range to the selected period
    fig.update_xaxes(
